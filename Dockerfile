...
ENV NUMINVERTORS=2
ENV INVERTOR_IP_1="10.0.0.11"
ENV NUMBATTERIES_1=2
ENV INVERTOR_AIO_1=False
ENV INVERTOR_AC_1=False
ENV INVERTOR_IP_2="10.0.0.12"
ENV NUMBATTERIES_2=2
...
ENV INFLUX_ORG=""
ENV HA_AUTO_D=True
ENV HADEVICEPREFIX="GivTCP_House"
ENV HADEVICEPREFIX_2="GivTCP_Garage"
ENV HADEVICEPREFIX_3="GivTCP3"
ENV PYTHONPATH="/app"
ENV DAYRATE=0.395
ENV NIGHTRATE=0.155
ENV EXPORTRATE=0.04
ENV HOSTIP="10.0.0.58"
ENV DYNAMICTARIFF=False
ENV DAYRATESTART="05:30"
ENV NIGHTRATESTART="23:30"
