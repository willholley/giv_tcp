...
class ThreePhaseInverter(RegisterGetter, metaclass=DynamicDoc):
    ...
    NEW_LUT = {
        ...
        "inverter_max_power": Def((C.hexfield,0), C.threeph_inverter_max_power, HR(1012)),   #Needs Type Hex[0]
        "battery_type": Def((C.hexfield,1), BatteryType, HR(1012)),   #Needs Type Hex[1]
        "Battery_Max_Power": Def((C.hexfield,2), C.battery_max_power, HR(1012)),   #Needs Type Hex[2]
        "Inverter_Type": Def((C.hexfield,1), InverterType, HR(1013)),   #Needs Type Hex[2]
