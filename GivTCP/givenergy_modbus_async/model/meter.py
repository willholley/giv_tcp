...
class Meter(RegisterGetter, metaclass=DynamicDoc):
    ...
    REGISTER_LUT = {
        ...
        "p_active_phase_1": Def(DT.uint16, None, IR(68)),
        "p_active_phase_2": Def(DT.uint16, None, IR(69)),
        "p_active_phase_3": Def(DT.uint16, None, IR(70)),
        "p_active_total": Def(DT.uint16, None, IR(71)),
        "p_reactive_phase_1": Def(DT.uint16, None, IR(72)),
        "p_reactive_phase_2": Def(DT.uint16, None, IR(73)),
        "p_reactive_phase_3": Def(DT.uint16, None, IR(74)),
        "p_reactive_total": Def(DT.uint16, None, IR(75)),
        "p_apparent_phase_1": Def(DT.uint16, None, IR(76)),
        "p_apparent_phase_2": Def(DT.uint16, None, IR(77)),
        "p_apparent_phase_3": Def(DT.uint16, None, IR(78)),
        "p_apparent_total": Def(DT.uint16, None, IR(79)),
        ...
        "frequency": Def(DT.milli, None, IR(84)),
